export const coursesData = [
    ...
    {
        id: "manual-servicos-dados",
        title: "MANUAL - SERVIÇOS AVANÇADOS DADOS",
        description: "Acesso rápido ao manual de Serviços Avançados Dados.",
        icon: "📘",
        duration: "10 min",
        departments: ["Todos"],
        modules: [
            {
                ...
                html: true,
                content: '<div style="position: relative; width: 100%; height: 0; padding-top: 56.2500%; padding-bottom: 0; box-shadow: 0 2px 8px 0 rgba(63,69,81,0.16); margin-top: 1.6em; margin-bottom: 0.9em; overflow: hidden; border-radius: 8px; will-change: transform;">\n  <iframe loading="lazy" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0; border: none; padding: 0;margin: 0;" src="https://www.canva.com/design/DAHJjxD52qA/nxen8DPvqy21caqBuQu5Tw/view?embed" allowfullscreen="allowfullscreen" allow="fullscreen"></iframe>\n</div>'
            }
        ]
    },
    {
        id: "manual-licencas-digitais",
        title: "MANUAL - LICENÇAS DIGITAIS",
        description: "Acesso rápido ao manual de Licenças Digitais.",
        icon: "📘",
        duration: "10 min",
        departments: ["Todos"],
        modules: [
            {
                ...
                html: true,
                content: '<div style="position: relative; width: 100%; height: 0; padding-top: 56.2500%; padding-bottom: 0; box-shadow: 0 2px 8px 0 rgba(63,69,81,0.16); margin-top: 1.6em; margin-bottom: 0.9em; overflow: hidden; border-radius: 8px; will-change: transform;">\n  <iframe loading="lazy" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0; border: none; padding: 0;margin: 0;" src="https://www.canva.com/design/DAHJeNnWg88/9f-azxxxuo85jZeiefDliw/view?embed" allowfullscreen="allowfullscreen" allow="fullscreen"></iframe>\n</div>'
            }
        ]
    },
    {
        ...
        description: "Acesso rápido ao manual de 0800 e 0300.",
        icon: "📘",
        duration: "10 min",
        departments: ["Todos"],
        modules: [
            {
                ...
                title: "0800 E 0300",
                html: true,
                content: '<div style="position: relative; width: 100%; height: 0; padding-top: 56.2500%; padding-bottom: 0; box-shadow: 0 2px 8px 0 rgba(63,69,81,0.16); margin-top: 1.6em; margin-bottom: 0.9em; overflow: hidden; border-radius: 8px; will-change: transform;">\n  <iframe loading="lazy" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0; border: none; padding: 0;margin: 0;" src="https://www.canva.com/design/DAHJwIbkyro/Zmyes03e87nZe130QxNjIw/view?embed" allowfullscreen="allowfullscreen" allow="fullscreen"></iframe>\n</div>'
            }
        ]
    }
];
