...
/**
 * MaterialViewer ÔÇö Tela de visualiza├º├úo de material estilo Hotmart
 * Layout: conte├║do principal (embed + coment├írios) + sidebar de navega├º├úo
 * Materiais s├úo exibidos via embed do Canva
 */

// Dados fixos dos materiais ÔÇö cada m├│dulo cont├®m materiais com embeds do Canva
const MODULES_DATA = [
    {
        id: 'mod-welcome',
    ...
    },
    {
        ...
        materials: [
            {
                id: 'mat-sistemas',
                title: '01 - Sistemas, Ferramentas e Di├írio de Bordo',
    ...
    },
    {
        ...
        materials: [
            {
                id: 'mat-manual-dados',
                title: '01 - Servi├ºos Avan├ºados Dados',
...
const MaterialViewer = ({ 
    ...
    // Coment├írios (preparado para futuro)
    ...
    // Progresso por m├│dulo (visual, local)
    ...
    if (!activeMaterial) {
        return (
            <div className="mv-error">
                <p>Material n├úo encontrado.</p>
                <button onClick={onBack} className="mv-back-btn-error">Voltar ao in├¡cio</button>
            </div>
        );
    }
    ...
    return (
        <div className={`material-viewer ${sidebarOpen ? '' : 'sidebar-collapsed'}`} id="material-viewer">
            ...
            <div className="mv-main">
                ...
                <div className="mv-actions-bar">
                    ...
                    <div className="mv-actions-right">
                        ...
                        >
                            {completedMaterials.includes(activeMaterial.id) ? 'Conclu├¡do' : 'Concluir'}
                ...
                {/* Link informa├º├Áes */}
                <button className="mv-info-link">Informa├º├Áes da aula</button>
                ...
                {/* ====== SE├ç├âO DE COMENT├üRIOS ====== */}
                <section className="mv-comments" id="mv-comments">
                    <h2 className="mv-comments-title">Coment├írios <span className="mv-comments-count">0</span></h2>
                    ...
                    <div className="mv-comments-empty">
                        ...
                        <h3>Ainda sem coment├írios por aqui</h3>
                        <p>Seja a primeira pessoa a comentar algo e inicie um t├│pico para trocar ideias sobre a aula.</p>
                    </div>
                </section>
            </div>

            {/* ====== SIDEBAR DE CONTE├ÜDOS ====== */}
            <aside className={`mv-sidebar ${sidebarOpen ? 'open' : ''}`} id="mv-sidebar">
                <div className="mv-sidebar-header">
                    <h2 className="mv-sidebar-title">Lista de Conte├║dos</h2>
                    <div className="mv-sidebar-actions">
                        <button className="mv-sidebar-icon-btn" aria-label="Configura├º├Áes">
            ...
            {/* Bot├úo para reabrir sidebar quando colapsada */}
            {!sidebarOpen && (
                <button
                    className="mv-sidebar-reopen"
                    onClick={() => setSidebarOpen(true)}
                    aria-label="Abrir lista de conte├║dos"
                >
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
